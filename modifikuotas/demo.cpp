...
int main(){
    ...
    Taskas3D *centroTaskas1 = tetraedroCentroTaskas(tetraedras); 
    ...
    cout << "Centro taskas: ";	rasykTaska(*centroTaskas1);
    cout << endl; 
    

    // is pradinio tetraedro konstruojam dvigubai didesni
    TaisyklingasisTetraedras *didesnisTetraedras = konstruotiDidesniTetraedra(tetraedras);
    cout << "Taisyklingojo tetraedro briaunos ilgis: " << atstumasTarpTasku(didesnisTetraedras->pirmas, didesnisTetraedras->antras) << endl;
    cout << "Taisyklingojo tetraedro pavirsiaus plotas: " << tetraedroPavirsiausPlotas(*didesnisTetraedras) << endl;
    cout << "Taisyklingojo tetraedro turis: " << tetraedroTuris(*didesnisTetraedras) << endl;
    Taskas3D *centroTaskas2 = tetraedroCentroTaskas(*didesnisTetraedras);
    cout << "Centro taskas: ";	rasykTaska(*centroTaskas2);
    cout << endl;
